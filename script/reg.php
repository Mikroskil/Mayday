...
if (isset($error)) {
	...
	echo $data;
	$query = mysql_query("INSERT INTO user (Nama, Jenis_Kelamin, Username, Password,Confirm_Pass,Email,tanggal)
	values ('$nama','$Gender','$username','$password','$c_password','$Email' ,CURDATE());");
}
